...
|**Примечание**: команды терминала следует выполнять на бортовом компьютере робота. [Инструкция по подключению к бортовому компьютеру робота](beginning.md#подключение-к-бортовому-компьютеру)|
...
2. В другом окно терминала выполнить команду:
```bash
